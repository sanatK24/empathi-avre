...
def compile_features_and_train():
    ...
    for (fold, (train_idx, val_idx)) in enumerate(skf.split(X, y)):
        ...
        clf = xgb.XGBClassifier(n_estimators=50, max_depth=3, learning_rate=0.1, random_state=42, eval_metric='logloss')
    ...
    final_model = xgb.XGBClassifier(n_estimators=50, max_depth=3, learning_rate=0.1, random_state=42, eval_metric='logloss')
