    ...
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        if (role === 'admin') {
          ...
          const creatorData = await apiService.getMyCreatedCampaigns(profile.accessToken).catch(() => []);
          ...
          const donationsData = await apiService.getCampaigns(profile.accessToken).catch(() => []);
