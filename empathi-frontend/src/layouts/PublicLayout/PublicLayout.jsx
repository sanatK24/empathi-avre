      ...
      <nav className="sticky top-0 z-50 glass border-b border-slate-100">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-3 group">
            ...
            <span className="text-2xl font-display font-bold text-slate-900 tracking-tight">AVRE</span>
          </Link>
      ...
      <footer className="bg-slate-50 border-t border-slate-100 py-12">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0 text-center md:text-left">
            ...
            <p className="text-sm text-slate-400">© 2026 AVRE Adaptive Engine. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
