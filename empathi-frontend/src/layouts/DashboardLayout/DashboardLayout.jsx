...
const DashboardLayout = ({ role = 'requester' }) => {
  ...
  const navItems = {
    requester: [
      { label: 'Dashboard', icon: LayoutDashboard, path: '/requester/dashboard' },
      { label: 'Create Request', icon: PlusCircle, path: '/requester/create' },
      { label: 'My Requests', icon: History, path: '/requester/history' },
      { label: 'Profile', icon: User, path: '/requester/profile' },
    ],
    vendor: [
      ...
      >
        <div className="h-full flex flex-col p-6">
          <div className="flex items-center space-x-3 mb-10">
            ...
            <span className="text-xl font-display font-bold text-slate-900">AVRE</span>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3 pl-2">
              <div className="text-right hidden sm:block">
                ...
                <p className="text-xs font-medium text-slate-500 mt-1 capitalize">{role}</p>
              </div>
