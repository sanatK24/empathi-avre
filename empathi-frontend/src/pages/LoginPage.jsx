...
import { Activity, Mail, Lock, Eye, EyeOff, ArrowRight, Github } from 'lucide-react';
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16">
        ...
        >
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-slate-500 font-medium">Log in to manage your vendor matches and requests.</p>
          </div>
          ...
          <div className="mt-8 flex gap-4">
             <Button variant="secondary" className="flex-1 h-12 shadow-none border-slate-200">
      ...
      <div className="hidden lg:block lg:w-1/2 bg-slate-50 p-12 relative overflow-hidden">
        ...
        <div className="h-full w-full flex flex-col items-center justify-center relative z-10">
          <div className="p-2 bg-white rounded-3xl shadow-premium max-w-sm">
             <div className="bg-slate-900 rounded-[1.5rem] p-8 text-white">
                <div className="flex items-center space-x-3 mb-10">
                    ...
                    <span className="font-display font-bold text-xl">AVRE</span>
                </div>
          ...
          <div className="mt-12 text-center max-w-sm">
             <h2 className="text-2xl font-display font-bold text-slate-900 mb-4">Mastering Adaptive Vendor Intelligence</h2>
             <p className="text-slate-500 font-medium">
                Our engine combines historical data with real-time variables to provide 
                the most accurate resource matches in the industry.
             </p>
          </div>
        </div>
      </div>
