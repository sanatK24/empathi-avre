...
class UserRole(str, enum.Enum):
    USER = "USER"; CREATOR = "CREATOR"; ADMIN = "ADMIN"; DONOR = "DONOR"
...
class CampaignCreatorTrust(Base):
    ...
    historical_fulfillment_rate, dispute_rate, anomaly_score, composite_trust_score = Column(Float, default=1.0), Column(Float, default=0.0), Column(Float, default=0.0), Column(Float, default=0.80)
    created_at = Column(DateTime, default=func.now())
